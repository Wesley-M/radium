...
export const SearchField = (props: SearchFieldProps) => {
    ...
    */
    ...
    /** 
     * If query changes, and the text is different, then change text
    */
    useEffect(() => {
...
const StyledSearch = ({ children, focus }: StyledSearchProps) => {
    ...
    const backgroundTrans = parseFloat(theme.theme("components.search.background.transparency"))
    ...
    return (
        <Box
            sx={{
                ...
                position: 'relative',
                border: `1px solid ${alpha(theme.palette("tx-primary"), backgroundTrans + 0.4)}`,
                borderRadius: theme.radius("md"),
                backgroundColor: alpha(theme.palette("tx-primary"), backgroundTrans),
    ...
    return (
        <Box
            sx={{
                ...
                color: alpha(theme.palette("tx-primary"), 0.7)
            }}
        >
            {children}
        </Box>
...
const StyledInputBase = (props: InputBaseProps) => {
    const theme = useTheme()
    const placeholderTrans = parseFloat(theme.theme("components.search.placeholder.transparency")) 
